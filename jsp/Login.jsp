...
<h1 id="heading" align="center">Welcome to PSR Travel Agency</h1>
</div>
<div>
<div style="width: 46%; height:246px; font-size: 20px; background-color:CadetBlue ; color:#fff; float: left; padding: 2%">PSR</div>
